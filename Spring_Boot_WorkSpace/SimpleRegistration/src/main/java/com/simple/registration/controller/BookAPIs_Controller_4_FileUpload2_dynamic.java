...
import com.simple.registration.helper.FileUploadHelper2;


@RestController
@RequestMapping("/api/v1") // Optional base path for better organization
public class BookAPIs_Controller_4_FileUpload2_dynamic {
